...
export default function SettingsPage() {
  ...
  return (
    <div className="rb-shell min-h-screen px-4 py-16">
      <div className="max-w-lg mx-auto space-y-10">
        <div>
          <h1 className="rb-heading text-3xl font-bold text-white">Settings</h1>
          <p className="mt-1 text-white/60 text-sm">{user.email}</p>
        </div>

        {/* API Key status */}
        <div className="rb-glass rounded-2xl p-6 space-y-4">
        ...
        {/* Update keys */}
        <form onSubmit={handleSave} className="rb-glass rounded-2xl p-6 space-y-5">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="rb-input w-full border border-white/15 rounded-xl px-4 py-2.5 text-white placeholder-white/30 focus:outline-none focus:border-blue-400 text-sm font-mono"
        ...
        {/* Danger zone */}
        <div className="border border-red-500/20 rounded-2xl p-6 space-y-3 bg-red-500/[0.03]">
