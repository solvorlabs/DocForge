...
export default function Home() {
  return (
    <main className="min-h-screen bg-black text-white">
      {/* Nav */}
      <nav className="absolute top-0 left-0 right-0 z-20 px-6 py-4 flex items-center justify-between max-w-6xl mx-auto">
        <div className="flex items-center gap-2 font-bold text-xl text-white">
          <Code2 className="w-6 h-6 text-blue-400" />
          DocForge
        </div>
        <div className="flex items-center gap-4">
          <Link href="/generate" className="text-sm text-white/60 hover:text-white transition-colors">
            Generate
          </Link>
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        {/* Beams canvas — fills the entire hero */}
      ...
      <section className="py-20">
        <div className="max-w-2xl mx-auto text-center px-6">
          ...
          <p className="text-white/50 mb-8">Takes 30–90 seconds. Free to use.</p>
          <Button asChild size="lg" className="bg-blue-500 hover:bg-blue-600 text-white">
