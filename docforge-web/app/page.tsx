...
import {
  ...
  CheckCircle2, Package, BookOpen, Puzzle,
} from 'lucide-react';
...
function RegPill({ label }: { label: string }) {
  return (
    <span className="inline-flex items-center px-3 py-1 rounded-full bg-white/5 border border-white/10 text-xs text-white/60 font-mono">
      {label}
    </span>
  );
}
  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          <Badge variant="outline" className="mb-6 border-white/20 text-white/70 bg-white/5 backdrop-blur-sm">
            Version-Aware AI Context for Developers
          </Badge>
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            ...
            <Button variant="outline" size="lg" asChild className="border-white/20 text-white hover:bg-white/10 bg-white/5 backdrop-blur-sm">
      ...
      <section className="max-w-5xl mx-auto px-6 py-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <Card key={title} className="bg-white/5 border-white/10 text-white">
      ...
      <section id="install" className="max-w-5xl mx-auto px-6 py-24">
        <h2 className="text-3xl font-bold text-center mb-3">Get DocForge</h2>
    ...
    "docforge": {
      ...
      "env": {
        "DOCFORGE_BACKEND_URL": "https://api.docforge.dev"
              ...
              <div className="mt-auto">
                <a
                  href="https://github.com/Shivoo29/docforge/tree/main/docforge-mcp"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 text-xs text-white/40 hover:text-white/70 transition-colors"
                >
...
code --install-extension docforge-1.0.0.vsix`}</CodeBlock>
              <div className="mt-auto">
                <a
                  href="https://github.com/Shivoo29/docforge/tree/main/docforge-vscode"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 text-xs text-white/40 hover:text-white/70 transition-colors"
                >
      ...
      <section className="max-w-5xl mx-auto px-6 py-24">
        <h2 className="text-3xl font-bold text-center mb-3">Works with everything</h2>
...
dcf shadcn/ui`}</CodeBlock>
      ...
      <section className="bg-white/[0.02] border-y border-white/5 py-24">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-center mb-12">Why developers use it</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
        ...
        <div className="max-w-2xl mx-auto text-center px-6">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            ...
            <Button variant="outline" size="lg" asChild className="border-white/20 text-white hover:bg-white/10 bg-white/5">
              <a href="https://github.com/Shivoo29/docforge" target="_blank" rel="noopener noreferrer">
                View on GitHub
              </a>
            </Button>
          </div>
      ...
      <footer className="border-t border-white/10 py-8">
        <div className="max-w-5xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-white/25">
          ...
          <div className="flex gap-6">
            <a href="https://github.com/Shivoo29/docforge" target="_blank" rel="noopener noreferrer" className="hover:text-white/50 transition-colors">GitHub</a>
